...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/drone.jpeg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/drone2.jpeg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/drone3.jpeg" alt="Third slide">
    </div>
     <div class="carousel-item">
      <img class="d-block w-100" src="images/drone4.png" alt="Third slide">
    </div>
  </div>
...
<div class="contenu_accueil">
		...
		<ul>
			<li>Satisfais ou remboursé</li>
			<li>Livraison 24/48h</li>
			<li>Paiement sécurisé</li>

		</ul>
		<h5>SAV</h5>
		<h6>Une question? Un problème?</h6>
		<h6>Appelez-Nous !</h6>
				...
				<div class="row">
					...
					<div class="div">
						<div class="tit">DERNIERS AJOUTS</div>
							<div class="card" style="width: 18rem; height:30rem;" id="carte">
							  <img class="card-img-top" src="<?= $p['image'] ?>" alt="Card image cap">
							 <div class="card-body">
							    <h5 class="card-title"><?= $p['nom_drone'] ?></h5>
