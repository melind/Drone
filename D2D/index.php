...
$t = $DB->query('SELECT * FROM product WHERE id_drone = 10');
$t = $t->fetch();
...
<html lang="en">
<head>
	<meta http-equiv="pragma" content="no-cache" /><!-- utilisateur ne garde pas en memoire en cahch navigateur =  fichier temporaire-->
	<title>Drone2Dames</title>
...
<body>
	...
	<img src="images/logo.png" id="logo" alt="logo représentant un drone dans un cercle rouge foncé">
	 <canvas id="myCanvas" width="300" height="300" onmousemove="mouseMove(event)"  onmousedown="_mouseDown()" onmouseup="_mouseUp()"></canvas>
	<div class="carou">
	...
	<div class="contenu_accueil">
		...
		<div class="col D">
			...
			<div class="rowp">
				<div class="div">
					<div class="tit">TENDANCE</div>
					<div class="card" id="carte">
						<img class="card-img-top" id="img_index" src="<?= $t['image'] ?>" alt="Card image cap">
						<div class="card-body" id='card_index'>
							<h4 class="card-title"><?= $t['nom_drone'] ?></h4>
							<p class="card-text">Prix : <?= $t['prix'] ?> €</p>
							<p class="card-text">Autonomie : <?= $t['autonomie'] ?> mn</p>
							<p class="card-text">Poids : <?= $t['poids'] ?> g</p>
							<p class="card-text">Vitesse : <?= $t['vitesse'] ?> km/h</p>
							<a href="pages/afficher_produit.php?id=<?php echo $t['id_drone']; ?>" id="btn_card" class="btn btn-primary">Description</a>
						</div>
					</div>
				</div>
				<div class="div">
