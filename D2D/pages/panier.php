...
$ip = $_SERVER['REMOTE_ADDR'];//connaitre adresse ip de l'utilisateur
...
<body>
	...
	<div id="shopping-cart">
		<div class="txt-heading">Votre panier <img class="imgt" src="/D2D/images/shopping-cart.svg" alt="icone d un caddie"/></div>
		<?php
		if(empty($_SESSION['panier_item'])) {
			echo'<span id="empty_cart"> Votre Panier est vide ! <img class="imgp" src="/D2D/images/shopping-bag.svg" alt="icone d un panier"/></span>';
		} ?>
		<div class="achat">
						<table class="table">
					...
					<tr>
						...
						// Verifie que le panier ne sois pas vide puis si le prix du produit est supérieur à 600€, permet de choisir une couleur sinon affiche une couleur par defaut
							...
							echo  '<select name="Couleur" id="">
								...
								<option value="Bleu">Bleu</option>
								<option value="Ruge">Rouge</option>
								<option value="Vert">Vert</option>
