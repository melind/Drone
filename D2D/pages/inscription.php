...
if(!empty($_POST))
{
	...
	{
		$id_public = uniqid();
		$DB->insert('INSERT INTO user (nom, prenom, mail, password, adresse, code_postale, ville, idpublic, rang) values (:nom, :prenom, :mail, :password, :adresse, :code_postale, :ville, :idpublic, 1)',
		array('nom' => $Nom, 'prenom' => $Prenom, 'mail' => $Mail, 'password' => crypt($Password, '$2a$10$1qAz2wSx3eDc4rFv5tGb5t'), 'adresse' => $Adresse, 'code_postale' => $CodeP, 'ville' => $Ville, 'idpublic' => $id_public));
	...
	<div class="containeur">
		<form method="post" action="inscription.php">
			...
			<fieldset class="infolivraison">
            	...
            	<input class="input"  name="CodeP" placeholder="Code Postale" value="<?php if (isset($CodeP)) echo $CodeP; ?>" maxlength="20" required="required">
    					</div>
					</div>
			</fieldset>
				<br>
	  ...
	  <input type="checkbox" name="v" value="B" class="ckeckins"  required="required"> Vous acceptez les Conditions Generales d'utilisation<br>
	  <input type="checkbox" name="v" value="B" class="ckeckins"required="required" > Vous acceptez de recevoir des mails de la part de Drone2Dames sur nos nouveaux arrivages <br><br>
