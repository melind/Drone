...
$com = $DB->query('SELECT * FROM commandes INNER JOIN product ON commandes.code_drone = product.code WHERE id_user='.$_SESSION['id_user']);
$com = $com->fetchAll();
foreach ($req as $r) {
}
...
<body>
	<img src="/D2D/images/logo.png" id="logo" alt="logo représentant un drone dans un cercle rouge foncé">
	  ...
	  <div class="col-4">
	    <div class="list-group" id="list-tab" role="tablist">
	      ...
	      <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">INFORMATIONS DE FACTURATION</a>
				<a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="profile">HISTORIQUE DES ACHATS</a>
	  ...
	  <div class="col-8">
	    <div class="tab-content" id="nav-tabContent">
	      	<div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
				...
				<a class="data-toggle="list" href="modifier_profil.php?id=<?php echo $_SESSION['id_user'] ?>" role="tab" aria-controls="messages"> <button class="btn btn-primary" id="modify"> MODIFIER PROFIL</button></a>
