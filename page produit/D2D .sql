...
--
-- Client :  localhost
-- Généré le :  Ven 06 Juillet 2018 à 23:36
...
INSERT INTO `categories` (`id_cat`, `nom`, `page`) VALUES
...
INSERT INTO `user` (`id_user`, `nom`, `prenom`, `mail`, `password`, `adresse`, `code_postale`, `ville`, `idpublic`) VALUES
...
(44, 'Drone', 'Drone', 'drone@drone.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5e.wCHH4UGKLJJregVS5vcqKIs7etbH26', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b37e61f35296'),
(45, 'Drone', 'Drone', 'drone@rone.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5e.wCHH4UGKLJJregVS5vcqKIs7etbH26', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b37ec683fe57'),
(46, 'St4', 'Z34', 'mel@hotmail.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eyRk6iOB9Ssf2Pg41NMN7r7rkGcApJVC', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b37ed74c2c38'),
(47, 'Me Me', 'G', 'me@hotmail.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5etg/cZ2ZY1LBghuwPFkQzUzdzxHn4cq2', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b38018992f11'),
(48, 'Me Me', 'G', 'm@hotmail.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5etg/cZ2ZY1LBghuwPFkQzUzdzxHn4cq2', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b3801d246ded'),
(49, 'Me Me', 'Q', 'ttt@hotmail.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eamiEtROvMVUOxuZcS/Ubi8ylIvC/MdS', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b3b4785c9d97'),
(50, 'M M', 'E', 'rrr@hotmail.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5e/FrL3f1Snj2dItdcxcHWwwIGhZ3Hj.S', '12 nnnnn', 93330, 'NEUILLY SUR MARNE', '5b3b4ad458f69'),
(51, 'Me', 'D', 'drone@one.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5ePq7dbgkmPzQ/wU40yawbox2N9w0kil6', 'D', 12345, 'Kjj', '5b3fd51e1968a'),
(52, 'Jj', 'J', 'jj@hotmail.fr', '$2a$10$1qAz2wSx3eDc4rFv5tGb5ed2U.bMZPeTDD2k.29vGrlFaQC45GokW', 'Jjjj', 93330, 'NEUILLY SUR MARNE', '5b3fd54e3c46f'),
(53, 'Me Me', 'K', 'k@gmail.com', '$2a$10$1qAz2wSx3eDc4rFv5tGb5ed2U.bMZPeTDD2k.29vGrlFaQC45GokW', '12 rue du frene', 93330, 'NEUILLY SUR MARNE', '5b3fd9b725523');
...
--
ALTER TABLE `product`
  MODIFY `id_drone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT pour la table `user`
--
ALTER TABLE `user`
  MODIFY `id_user` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `id_cat_const` FOREIGN KEY (`id_cat`) REFERENCES `categories` (`id_cat`) ON DELETE CASCADE ON UPDATE CASCADE;
